                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                ...
                                <div class="aboutinfo-contact">
                                    <a target="_blank" title="网站首页" href="/blog"><i class="fa fa-home fa-2x" style="font-size:2.5em;position:relative;top:3px"></i></a>
                                    <a target="_blank" title="文章专栏" href="/blog/article"><i class="fa fa-file-text fa-2x"></i></a>
                                    <a target="_blank" title="资源分享" href="/blog/resource"><i class="fa fa-tags fa-2x"></i></a>
                                    <a target="_blank" title="点点滴滴" href="/blog/timeline"><i class="fa fa-hourglass-half fa-2x"></i></a>
                                </div>
