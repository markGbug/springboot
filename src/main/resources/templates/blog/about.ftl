                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                ...
                                <div class="aboutinfo-contact">
                                    <a target="_blank" title="网站首页" href="/blog"><i class="fa fa-home fa-2x"
                                                                                    style="font-size:2.5em;position:relative;top:3px"></i></a>
                                    <a target="_blank" title="文章专栏" href="/blog/article"><i
                                            class="fa fa-file-text fa-2x"></i></a>
                                    <a target="_blank" title="资源分享" href="/blog/resource"><i
                                            class="fa fa-tags fa-2x"></i></a>
                                    <a target="_blank" title="点点滴滴" href="/blog/timeline"><i
                                ...
                                <fieldset class="layui-elem-field layui-field-title">
                                    ...
                                    <div class="layui-field-box aboutinfo-abstract abstract-bloger">
                                        <p style="text-align:center;">
                                            Absolutely，不落阁创始人，诞生于1996年2月14日，目前是一个码农，从事.NET开发。</p>
                                        <h1>个人信息</h1>
                                        <p>暂无</p>
                                        <h1>个人介绍</h1>
                                        ...
                                        <ul class="friendlink">
                                            ...
                                            <li>
                                                <a target="_blank" href="http://www.pagemark.cn/" title="页签"
                                                   class="friendlink-item">
                                                    <p class="friendlink-item-pic"><img
                                                            src="http://pm.lyblogs.cn/Images/logo-png.png" alt="页签"/>
                                                    </p>
